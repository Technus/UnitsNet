...
{
    /// <inheritdoc />
    public override bool CanConvertTo(ITypeDescriptorContext? context, Type? destinationType) => destinationType switch
    {
    ...
    {
        if (value is not QuantityValue quantityValue)
