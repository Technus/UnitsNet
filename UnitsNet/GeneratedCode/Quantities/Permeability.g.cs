        ...
        IFormattable
    {
        ...
        public sealed class PermeabilityInfo : QuantityInfo<Permeability, PermeabilityUnit>
        {
            ...
            public static BaseDimensions DefaultBaseDimensions
            {
                ...
                get;
            } = new BaseDimensions(1, 1, -2, -2, 0, 0, 0);
        ...
        /// </summary>
        public static PermeabilityUnit BaseUnit
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// </summary>
        public static IReadOnlyCollection<PermeabilityUnit> Units
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info.Units;
        }
        ...
        /// </summary>
        public static Permeability Zero
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info.Zero;
        }
        ...
        /// <inheritdoc />
        public QuantityInfo<Permeability, PermeabilityUnit> QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
...
#if NETSTANDARD2_0
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IQuantityInstanceInfo<Permeability> IQuantityOfType<Permeability>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        QuantityInfo<PermeabilityUnit> IQuantity<PermeabilityUnit>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        /// </summary>
        public QuantityValue HenriesPerMeter
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(PermeabilityUnit.HenryPerMeter);
        }
        ...
        public static Permeability FromHenriesPerMeter(QuantityValue value)
            => new(value, PermeabilityUnit.HenryPerMeter);
        ...
        public static Permeability Parse(string str, IFormatProvider? provider)
            => QuantityParser.Default.Parse<Permeability, PermeabilityUnit>(str, provider, From);
        ...
        public static bool TryParse([NotNullWhen(true)]string? str, IFormatProvider? provider, out Permeability result)
            => QuantityParser.Default.TryParse<Permeability, PermeabilityUnit>(str, provider, From, out result);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator QuantityValue(Permeability d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Permeability(QuantityValue d) => new(d, BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(Permeability d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Permeability(double d) => new(d, BaseUnit);
        ...
        public static QuantityValue operator /(Permeability left, Permeability right)
            => left.HenriesPerMeter / right.HenriesPerMeter;
        ...
        /// <summary>
        ///     Determines whether two <see cref="Permeability"/> instances are equal.
        /// </summary>
        /// <remarks>
        ...
        ///     The operator delegates to <see cref="Equals(Permeability)"/>, which implements this conversion-and-compare logic.
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(Permeability left, Permeability right)
            => left.Equals(right);
        ...
        /// <summary>
        ///     Determines whether two <see cref="Permeability"/> instances are not equal.
        /// </summary>
        /// <remarks>
        ///     This operator is the logical negation of <see cref="operator ==(Permeability,Permeability)"/>.
        ///     See that operator (and <see cref="Equals(Permeability)"/>) for details on how equality is evaluated
        ...
        /// <inheritdoc />
        /// <summary>
        ///     Determines whether the specified object is equal to the current <see cref="Permeability"/> instance.
        /// </summary>
        /// <remarks>
        ///     Returns <c>false</c> if <paramref name="obj"/> is <c>null</c> or not a <see cref="Permeability"/>.
        ///     When <paramref name="obj"/> is a <see cref="Permeability"/>, this method delegates to
        ///     <see cref="Equals(Permeability)"/>, which performs a unit-aware comparison by converting the other
        ///     instance to this instance's unit before comparing numeric values.
        /// </remarks>
        public override bool Equals(object? obj)
            => obj is Permeability otherQuantity && Equals(otherQuantity);

        /// <inheritdoc />
        /// <summary>
        ///     Determines whether the current instance is equal to another <see cref="Permeability"/> instance.
        /// </summary>
        /// <remarks>
        ...
        public override int GetHashCode()
            => Comparison.GetHashCode(typeof(Permeability), this.As(BaseUnit));
