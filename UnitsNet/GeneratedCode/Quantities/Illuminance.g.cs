...
namespace UnitsNet
{
    ...
    public readonly partial struct Illuminance :
        ILinearQuantity<Illuminance, IlluminanceUnit>,
        ...
        IFormattable
    {
        ...
        /// </summary>
        public static IReadOnlyCollection<IlluminanceUnit> Units
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info.Units;
        }
        ...
        /// <inheritdoc />
        public QuantityInfo<Illuminance, IlluminanceUnit> QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
...
#if NETSTANDARD2_0
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IQuantityInstanceInfo<Illuminance> IQuantityOfType<Illuminance>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        QuantityInfo<IlluminanceUnit> IQuantity<IlluminanceUnit>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Illuminance AsBaseQuantity()
        ...
        public static Illuminance FromKilolux(QuantityValue value)
            => new(value, IlluminanceUnit.Kilolux);
        ...
        public static Illuminance FromMegalux(QuantityValue value)
            => new(value, IlluminanceUnit.Megalux);
        ...
        public static Illuminance FromMillilux(QuantityValue value)
            => new(value, IlluminanceUnit.Millilux);
        ...
        public static Illuminance Parse(string str, IFormatProvider? provider)
            => QuantityParser.Default.Parse<Illuminance, IlluminanceUnit>(str, provider, From);
        ...
        public static bool TryParse([NotNullWhen(true)]string? str, IFormatProvider? provider, out Illuminance result)
            => QuantityParser.Default.TryParse<Illuminance, IlluminanceUnit>(str, provider, From, out result);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator QuantityValue(Illuminance d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Illuminance(QuantityValue d) => new(d, BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(Illuminance d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Illuminance(double d) => new(d, BaseUnit);
        ...
        public static LuminousFlux operator *(Illuminance illuminance, Area area)
            => LuminousFlux.FromLumens(illuminance.Lux * area.SquareMeters);
        ...
        /// <summary>
        ///     Determines whether two <see cref="Illuminance"/> instances are equal.
        /// </summary>
        /// <remarks>
        ...
        ///     The operator delegates to <see cref="Equals(Illuminance)"/>, which implements this conversion-and-compare logic.
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(Illuminance left, Illuminance right)
            => left.Equals(right);
        ...
        /// <summary>
        ///     Determines whether two <see cref="Illuminance"/> instances are not equal.
        /// </summary>
        /// <remarks>
        ///     This operator is the logical negation of <see cref="operator ==(Illuminance,Illuminance)"/>.
        ///     See that operator (and <see cref="Equals(Illuminance)"/>) for details on how equality is evaluated
        ...
        /// <inheritdoc />
        /// <summary>
        ///     Determines whether the specified object is equal to the current <see cref="Illuminance"/> instance.
        /// </summary>
        /// <remarks>
        ///     Returns <c>false</c> if <paramref name="obj"/> is <c>null</c> or not a <see cref="Illuminance"/>.
        ///     When <paramref name="obj"/> is a <see cref="Illuminance"/>, this method delegates to
        ///     <see cref="Equals(Illuminance)"/>, which performs a unit-aware comparison by converting the other
        ///     instance to this instance's unit before comparing numeric values.
        /// </remarks>
        public override bool Equals(object? obj)
            => obj is Illuminance otherQuantity && Equals(otherQuantity);

        /// <inheritdoc />
        /// <summary>
        ///     Determines whether the current instance is equal to another <see cref="Illuminance"/> instance.
        /// </summary>
        /// <remarks>
        ...
        public override int GetHashCode()
            => Comparison.GetHashCode(typeof(Illuminance), this.As(BaseUnit));
