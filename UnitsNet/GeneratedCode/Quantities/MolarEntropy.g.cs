...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        {
            /// <inheritdoc />
            public MolarEntropyInfo(string name, MolarEntropyUnit baseUnit, MolarEntropyUnit siBaseUnit, IEnumerable<IUnitDefinition<MolarEntropyUnit>> unitMappings, MolarEntropy zero, BaseDimensions baseDimensions,
            ...
            /// <inheritdoc />
            public MolarEntropyInfo(string name, MolarEntropyUnit baseUnit, MolarEntropyUnit siBaseUnit, IEnumerable<IUnitDefinition<MolarEntropyUnit>> unitMappings, MolarEntropy zero, BaseDimensions baseDimensions)
                : this(name, baseUnit, siBaseUnit, unitMappings, zero, baseDimensions, MolarEntropy.From, new ResourceManager("UnitsNet.GeneratedCode.Resources.MolarEntropy", typeof(MolarEntropy).Assembly))
            {
            }
            ...
            public static MolarEntropyInfo CreateDefault()
                => new(nameof(MolarEntropy), DefaultBaseUnit, DefaultSiBaseUnit, GetDefaultMappings(), new(0, DefaultBaseUnit), DefaultBaseDimensions);
            ...
            public static MolarEntropyInfo CreateDefault(Func<IEnumerable<UnitDefinition<MolarEntropyUnit>>, IEnumerable<IUnitDefinition<MolarEntropyUnit>>> customizeUnits)
                => new(nameof(MolarEntropy), DefaultBaseUnit, DefaultSiBaseUnit, customizeUnits(GetDefaultMappings()), new(0, DefaultBaseUnit), DefaultBaseDimensions);
            ...
            public static BaseDimensions DefaultBaseDimensions
            {
                ...
                get;
            } = new BaseDimensions(2, 1, -2, 0, -1, -1, 0);
            ...
            /// </summary>
            public static MolarEntropyUnit DefaultBaseUnit
            {
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                get;
            ...
            /// <summary>
            ///     The default base unit of MolarEntropy is JoulePerMoleKelvin.
            /// </summary>
            public static MolarEntropyUnit DefaultSiBaseUnit
            {
                [MethodImpl(MethodImplOptions.AggressiveInlining)]
                get;
            } = MolarEntropyUnit.JoulePerMoleKelvin;
        ...
        /// <summary>
        ///     The SI base unit of MolarEntropy, which is JoulePerMoleKelvin.
        /// </summary>
        public static MolarEntropyUnit SiBaseUnit
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => MolarEntropyUnit.JoulePerMoleKelvin;
        }

        /// <summary>
        ///     All units of measurement for the MolarEntropy quantity.
        /// </summary>
        public static IReadOnlyCollection<MolarEntropyUnit> Units
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info.Units;
        }
        ...
        /// <inheritdoc />
        public QuantityInfo<MolarEntropy, MolarEntropyUnit> QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
...
#if NETSTANDARD2_0
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IQuantityInstanceInfo<MolarEntropy> IQuantityOfType<MolarEntropy>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        QuantityInfo<MolarEntropyUnit> IQuantity<MolarEntropyUnit>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        /// <returns><see cref="MolarEntropyUnit.JoulePerMoleKelvin"/></returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public MolarEntropy AsSiBaseQuantity()
        ...
        /// </summary>
        public QuantityValue JoulesPerMoleKelvin
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(MolarEntropyUnit.JoulePerMoleKelvin);
        }

        /// <summary>
        ///     Gets a <see cref="QuantityValue"/> value of this quantity converted into <see cref="MolarEntropyUnit.KilojoulePerMoleKelvin"/>
        /// </summary>
        public QuantityValue KilojoulesPerMoleKelvin
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(MolarEntropyUnit.KilojoulePerMoleKelvin);
        }

        /// <summary>
        ///     Gets a <see cref="QuantityValue"/> value of this quantity converted into <see cref="MolarEntropyUnit.MegajoulePerMoleKelvin"/>
        /// </summary>
        public QuantityValue MegajoulesPerMoleKelvin
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(MolarEntropyUnit.MegajoulePerMoleKelvin);
        }
        ...
        public static MolarEntropy FromJoulesPerMoleKelvin(QuantityValue value)
            => new(value, MolarEntropyUnit.JoulePerMoleKelvin);
        ...
        public static MolarEntropy FromKilojoulesPerMoleKelvin(QuantityValue value)
            => new(value, MolarEntropyUnit.KilojoulePerMoleKelvin);
        ...
        public static MolarEntropy FromMegajoulesPerMoleKelvin(QuantityValue value)
            => new(value, MolarEntropyUnit.MegajoulePerMoleKelvin);
        ...
        public static MolarEntropy Parse(string str, IFormatProvider? provider)
            => QuantityParser.Default.Parse<MolarEntropy, MolarEntropyUnit>(str, provider, From);
        ...
        public static bool TryParse([NotNullWhen(true)]string? str, IFormatProvider? provider, out MolarEntropy result)
            => QuantityParser.Default.TryParse<MolarEntropy, MolarEntropyUnit>(str, provider, From, out result);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator QuantityValue(MolarEntropy d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MolarEntropy(QuantityValue d) => new(d, BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(MolarEntropy d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator MolarEntropy(double d) => new(d, BaseUnit);
        ...
        public static QuantityValue operator /(MolarEntropy left, MolarEntropy right)
            => left.JoulesPerMoleKelvin / right.JoulesPerMoleKelvin;
        ...
        /// <summary>
        ///     Determines whether two <see cref="MolarEntropy"/> instances are equal.
        /// </summary>
        /// <remarks>
        ...
        ///     The operator delegates to <see cref="Equals(MolarEntropy)"/>, which implements this conversion-and-compare logic.
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(MolarEntropy left, MolarEntropy right)
            => left.Equals(right);
        ...
        /// <summary>
        ///     Determines whether two <see cref="MolarEntropy"/> instances are not equal.
        /// </summary>
        /// <remarks>
        ///     This operator is the logical negation of <see cref="operator ==(MolarEntropy,MolarEntropy)"/>.
        ///     See that operator (and <see cref="Equals(MolarEntropy)"/>) for details on how equality is evaluated
        ...
        /// <inheritdoc />
        /// <summary>
        ///     Determines whether the specified object is equal to the current <see cref="MolarEntropy"/> instance.
        /// </summary>
        /// <remarks>
        ///     Returns <c>false</c> if <paramref name="obj"/> is <c>null</c> or not a <see cref="MolarEntropy"/>.
        ///     When <paramref name="obj"/> is a <see cref="MolarEntropy"/>, this method delegates to
        ///     <see cref="Equals(MolarEntropy)"/>, which performs a unit-aware comparison by converting the other
        ///     instance to this instance's unit before comparing numeric values.
        /// </remarks>
        public override bool Equals(object? obj)
            => obj is MolarEntropy otherQuantity && Equals(otherQuantity);

        /// <inheritdoc />
        /// <summary>
        ///     Determines whether the current instance is equal to another <see cref="MolarEntropy"/> instance.
        /// </summary>
        /// <remarks>
        ...
        public override int GetHashCode()
            => Comparison.GetHashCode(typeof(MolarEntropy), this.As(BaseUnit));
