...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        /// </summary>
        public static IReadOnlyCollection<RatioChangeRateUnit> Units
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info.Units;
        }
        ...
        /// <inheritdoc />
        public RatioChangeRateUnit Unit
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <inheritdoc />
        public QuantityInfo<RatioChangeRate, RatioChangeRateUnit> QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
...
#if NETSTANDARD2_0
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IQuantityInstanceInfo<RatioChangeRate> IQuantityOfType<RatioChangeRate>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        QuantityInfo<RatioChangeRateUnit> IQuantity<RatioChangeRateUnit>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        /// </summary>
        public QuantityValue DecimalFractionsPerSecond
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(RatioChangeRateUnit.DecimalFractionPerSecond);
        }

        /// <summary>
        ///     Gets a <see cref="QuantityValue"/> value of this quantity converted into <see cref="RatioChangeRateUnit.PercentPerSecond"/>
        /// </summary>
        public QuantityValue PercentsPerSecond
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(RatioChangeRateUnit.PercentPerSecond);
        }
        ...
        public static RatioChangeRate FromDecimalFractionsPerSecond(QuantityValue value)
            => new(value, RatioChangeRateUnit.DecimalFractionPerSecond);
        ...
        public static RatioChangeRate FromPercentsPerSecond(QuantityValue value)
            => new(value, RatioChangeRateUnit.PercentPerSecond);
        ...
        public static RatioChangeRate Parse(string str, IFormatProvider? provider)
            => QuantityParser.Default.Parse<RatioChangeRate, RatioChangeRateUnit>(str, provider, From);
        ...
        public static bool TryParse([NotNullWhen(true)]string? str, IFormatProvider? provider, out RatioChangeRate result)
            => QuantityParser.Default.TryParse<RatioChangeRate, RatioChangeRateUnit>(str, provider, From, out result);
        ...
        public static QuantityValue operator /(RatioChangeRate left, RatioChangeRate right)
            => left.DecimalFractionsPerSecond / right.DecimalFractionsPerSecond;
        ...
        public static Ratio operator *(RatioChangeRate ratioChangeRate, Duration duration)
            => Ratio.FromDecimalFractions(ratioChangeRate.DecimalFractionsPerSecond * duration.Seconds);
        ...
        /// <summary>
        ///     Determines whether two <see cref="RatioChangeRate"/> instances are equal.
        /// </summary>
        /// <remarks>
        ...
        ///     The operator delegates to <see cref="Equals(RatioChangeRate)"/>, which implements this conversion-and-compare logic.
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(RatioChangeRate left, RatioChangeRate right)
            => left.Equals(right);
        ...
        /// <summary>
        ///     Determines whether two <see cref="RatioChangeRate"/> instances are not equal.
        /// </summary>
        /// <remarks>
        ///     This operator is the logical negation of <see cref="operator ==(RatioChangeRate,RatioChangeRate)"/>.
        ///     See that operator (and <see cref="Equals(RatioChangeRate)"/>) for details on how equality is evaluated
        ...
        /// <inheritdoc />
        /// <summary>
        ///     Determines whether the specified object is equal to the current <see cref="RatioChangeRate"/> instance.
        /// </summary>
        /// <remarks>
        ///     Returns <c>false</c> if <paramref name="obj"/> is <c>null</c> or not a <see cref="RatioChangeRate"/>.
        ///     When <paramref name="obj"/> is a <see cref="RatioChangeRate"/>, this method delegates to
        ///     <see cref="Equals(RatioChangeRate)"/>, which performs a unit-aware comparison by converting the other
        ///     instance to this instance's unit before comparing numeric values.
        /// </remarks>
        public override bool Equals(object? obj)
            => obj is RatioChangeRate otherQuantity && Equals(otherQuantity);

        /// <inheritdoc />
        /// <summary>
        ///     Determines whether the current instance is equal to another <see cref="RatioChangeRate"/> instance.
        /// </summary>
        /// <remarks>
        ...
        public override int GetHashCode()
            => Comparison.GetHashCode(typeof(RatioChangeRate), this.As(BaseUnit));
