        ...
        IFormattable
    {
        ...
        public sealed class MagnetizationInfo : QuantityInfo<Magnetization, MagnetizationUnit>
        {
            ...
            public static BaseDimensions DefaultBaseDimensions
            {
                ...
                get;
            } = new BaseDimensions(-1, 0, 0, 1, 0, 0, 0);
        ...
        /// </summary>
        public static IReadOnlyCollection<MagnetizationUnit> Units
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info.Units;
        }
        ...
        /// <inheritdoc />
        public QuantityInfo<Magnetization, MagnetizationUnit> QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
...
#if NETSTANDARD2_0
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IQuantityInstanceInfo<Magnetization> IQuantityOfType<Magnetization>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        QuantityInfo<MagnetizationUnit> IQuantity<MagnetizationUnit>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        /// </summary>
        public QuantityValue AmperesPerMeter
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(MagnetizationUnit.AmperePerMeter);
        }
        ...
        public static Magnetization FromAmperesPerMeter(QuantityValue value)
            => new(value, MagnetizationUnit.AmperePerMeter);
        ...
        public static Magnetization Parse(string str, IFormatProvider? provider)
            => QuantityParser.Default.Parse<Magnetization, MagnetizationUnit>(str, provider, From);
        ...
        public static bool TryParse([NotNullWhen(true)]string? str, IFormatProvider? provider, out Magnetization result)
            => QuantityParser.Default.TryParse<Magnetization, MagnetizationUnit>(str, provider, From, out result);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator QuantityValue(Magnetization d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Magnetization(QuantityValue d) => new(d, BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(Magnetization d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Magnetization(double d) => new(d, BaseUnit);
        ...
        public static QuantityValue operator /(Magnetization left, Magnetization right)
            => left.AmperesPerMeter / right.AmperesPerMeter;
        ...
        public override bool Equals(object? obj)
            => obj is Magnetization otherQuantity && Equals(otherQuantity);
        ...
        public override int GetHashCode()
            => Comparison.GetHashCode(typeof(Magnetization), this.As(BaseUnit));
