...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        /// </summary>
        public static IReadOnlyCollection<SpecificVolumeUnit> Units
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info.Units;
        }
        ...
        /// <inheritdoc />
        public QuantityInfo<SpecificVolume, SpecificVolumeUnit> QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
...
#if NETSTANDARD2_0
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IQuantityInstanceInfo<SpecificVolume> IQuantityOfType<SpecificVolume>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        QuantityInfo<SpecificVolumeUnit> IQuantity<SpecificVolumeUnit>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        /// </summary>
        public QuantityValue CubicFeetPerPound
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(SpecificVolumeUnit.CubicFootPerPound);
        }

        /// <summary>
        ///     Gets a <see cref="QuantityValue"/> value of this quantity converted into <see cref="SpecificVolumeUnit.CubicMeterPerKilogram"/>
        /// </summary>
        public QuantityValue CubicMetersPerKilogram
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(SpecificVolumeUnit.CubicMeterPerKilogram);
        }
        ...
        /// </summary>
        public QuantityValue CubicMillimetersPerKilogram
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(SpecificVolumeUnit.CubicMillimeterPerKilogram);
        }
        ...
        public static SpecificVolume FromCubicFeetPerPound(QuantityValue value)
            => new(value, SpecificVolumeUnit.CubicFootPerPound);
        ...
        public static SpecificVolume FromCubicMetersPerKilogram(QuantityValue value)
            => new(value, SpecificVolumeUnit.CubicMeterPerKilogram);
        ...
        public static SpecificVolume FromCubicMillimetersPerKilogram(QuantityValue value)
            => new(value, SpecificVolumeUnit.CubicMillimeterPerKilogram);
        ...
        public static SpecificVolume Parse(string str, IFormatProvider? provider)
            => QuantityParser.Default.Parse<SpecificVolume, SpecificVolumeUnit>(str, provider, From);
        ...
        public static bool TryParse([NotNullWhen(true)]string? str, IFormatProvider? provider, out SpecificVolume result)
            => QuantityParser.Default.TryParse<SpecificVolume, SpecificVolumeUnit>(str, provider, From, out result);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator QuantityValue(SpecificVolume d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SpecificVolume(QuantityValue d) => new(d, BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(SpecificVolume d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator SpecificVolume(double d) => new(d, BaseUnit);
        ...
        public static QuantityValue operator /(SpecificVolume left, SpecificVolume right)
            => left.CubicMetersPerKilogram / right.CubicMetersPerKilogram;
        ...
        public Density Inverse()
            => UnitConverter.Default.ConvertTo(Value, Unit, Density.Info);
        ...
        public static Volume operator *(SpecificVolume specificVolume, Mass mass)
            => Volume.FromCubicMeters(specificVolume.CubicMetersPerKilogram * mass.Kilograms);
        ...
        public override bool Equals(object? obj)
            => obj is SpecificVolume otherQuantity && Equals(otherQuantity);
        ...
        public override int GetHashCode()
            => Comparison.GetHashCode(typeof(SpecificVolume), this.As(BaseUnit));
