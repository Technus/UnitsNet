...
namespace UnitsNet
{
    ...
    public readonly partial struct Scalar :
        ILinearQuantity<Scalar, ScalarUnit>,
        ...
        IFormattable
    {
        ...
        /// </summary>
        public static ScalarUnit BaseUnit
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// </summary>
        public static IReadOnlyCollection<ScalarUnit> Units
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info.Units;
        }
        ...
        /// <inheritdoc />
        public QuantityInfo<Scalar, ScalarUnit> QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
...
#if NETSTANDARD2_0
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IQuantityInstanceInfo<Scalar> IQuantityOfType<Scalar>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        QuantityInfo<ScalarUnit> IQuantity<ScalarUnit>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        /// </summary>
        public QuantityValue Amount
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(ScalarUnit.Amount);
        }
        ...
        public static Scalar Parse(string str, IFormatProvider? provider)
            => QuantityParser.Default.Parse<Scalar, ScalarUnit>(str, provider, From);
        ...
        public static bool TryParse([NotNullWhen(true)]string? str, IFormatProvider? provider, out Scalar result)
            => QuantityParser.Default.TryParse<Scalar, ScalarUnit>(str, provider, From, out result);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator QuantityValue(Scalar d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Scalar(QuantityValue d) => new(d, BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(Scalar d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Scalar(double d) => new(d, BaseUnit);
        ...
        /// <summary>
        ///     Determines whether two <see cref="Scalar"/> instances are equal.
        /// </summary>
        /// <remarks>
        ...
        ///     The operator delegates to <see cref="Equals(Scalar)"/>, which implements this conversion-and-compare logic.
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(Scalar left, Scalar right)
            => left.Equals(right);
        ...
        /// <summary>
        ///     Determines whether two <see cref="Scalar"/> instances are not equal.
        /// </summary>
        /// <remarks>
        ///     This operator is the logical negation of <see cref="operator ==(Scalar,Scalar)"/>.
        ///     See that operator (and <see cref="Equals(Scalar)"/>) for details on how equality is evaluated
        ...
        /// <inheritdoc />
        /// <summary>
        ///     Determines whether the specified object is equal to the current <see cref="Scalar"/> instance.
        /// </summary>
        /// <remarks>
        ///     Returns <c>false</c> if <paramref name="obj"/> is <c>null</c> or not a <see cref="Scalar"/>.
        ///     When <paramref name="obj"/> is a <see cref="Scalar"/>, this method delegates to
        ///     <see cref="Equals(Scalar)"/>, which performs a unit-aware comparison by converting the other
        ///     instance to this instance's unit before comparing numeric values.
        /// </remarks>
        public override bool Equals(object? obj)
            => obj is Scalar otherQuantity && Equals(otherQuantity);

        /// <inheritdoc />
        /// <summary>
        ///     Determines whether the current instance is equal to another <see cref="Scalar"/> instance.
        /// </summary>
        /// <remarks>
        ...
        public override int GetHashCode()
            => Comparison.GetHashCode(typeof(Scalar), this.As(BaseUnit));
