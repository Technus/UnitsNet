...
namespace UnitsNet
{
        ...
        IFormattable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator QuantityValue(Speed d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Speed(QuantityValue d) => new(d, BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(Speed d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Speed(double d) => new(d, BaseUnit);
