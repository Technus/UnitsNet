...
namespace UnitsNet
{
    ...
    public readonly partial struct SpecificEntropy :
        ILinearQuantity<SpecificEntropy, SpecificEntropyUnit>,
        ...
        IFormattable
    {
        ...
        public sealed class SpecificEntropyInfo : QuantityInfo<SpecificEntropy, SpecificEntropyUnit>
        {
            ...
            public static BaseDimensions DefaultBaseDimensions
            {
                ...
                get;
            } = new BaseDimensions(2, 0, -2, 0, -1, 0, 0);
        ...
        /// <inheritdoc />
        public SpecificEntropyUnit Unit
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        /// <inheritdoc />
        public QuantityInfo<SpecificEntropy, SpecificEntropyUnit> QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
...
#if NETSTANDARD2_0
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        IQuantityInstanceInfo<SpecificEntropy> IQuantityOfType<SpecificEntropy>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        [DebuggerBrowsable(DebuggerBrowsableState.Never)]
        QuantityInfo<SpecificEntropyUnit> IQuantity<SpecificEntropyUnit>.QuantityInfo
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => Info;
        }
        ...
        /// </summary>
        public QuantityValue BtusPerPoundFahrenheit
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(SpecificEntropyUnit.BtuPerPoundFahrenheit);
        }

        /// <summary>
        ///     Gets a <see cref="QuantityValue"/> value of this quantity converted into <see cref="SpecificEntropyUnit.CaloriePerGramKelvin"/>
        /// </summary>
        public QuantityValue CaloriesPerGramKelvin
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(SpecificEntropyUnit.CaloriePerGramKelvin);
        }
        ...
        /// </summary>
        public QuantityValue JoulesPerKilogramDegreeCelsius
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(SpecificEntropyUnit.JoulePerKilogramDegreeCelsius);
        }

        /// <summary>
        ///     Gets a <see cref="QuantityValue"/> value of this quantity converted into <see cref="SpecificEntropyUnit.JoulePerKilogramKelvin"/>
        /// </summary>
        public QuantityValue JoulesPerKilogramKelvin
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(SpecificEntropyUnit.JoulePerKilogramKelvin);
        }
        ...
        /// </summary>
        public QuantityValue KilocaloriesPerGramKelvin
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(SpecificEntropyUnit.KilocaloriePerGramKelvin);
        }
        ...
        /// </summary>
        public QuantityValue KilojoulesPerKilogramDegreeCelsius
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(SpecificEntropyUnit.KilojoulePerKilogramDegreeCelsius);
        }
        ...
        /// </summary>
        public QuantityValue KilojoulesPerKilogramKelvin
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(SpecificEntropyUnit.KilojoulePerKilogramKelvin);
        }
        ...
        /// </summary>
        public QuantityValue MegajoulesPerKilogramDegreeCelsius
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(SpecificEntropyUnit.MegajoulePerKilogramDegreeCelsius);
        }
        ...
        /// </summary>
        public QuantityValue MegajoulesPerKilogramKelvin
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => this.As(SpecificEntropyUnit.MegajoulePerKilogramKelvin);
        }
        ...
        public static SpecificEntropy FromBtusPerPoundFahrenheit(QuantityValue value)
            => new(value, SpecificEntropyUnit.BtuPerPoundFahrenheit);
        ...
        public static SpecificEntropy FromCaloriesPerGramKelvin(QuantityValue value)
            => new(value, SpecificEntropyUnit.CaloriePerGramKelvin);
        ...
        public static SpecificEntropy FromJoulesPerKilogramDegreeCelsius(QuantityValue value)
            => new(value, SpecificEntropyUnit.JoulePerKilogramDegreeCelsius);
        ...
        public static SpecificEntropy FromJoulesPerKilogramKelvin(QuantityValue value)
            => new(value, SpecificEntropyUnit.JoulePerKilogramKelvin);
        ...
        public static SpecificEntropy FromKilocaloriesPerGramKelvin(QuantityValue value)
            => new(value, SpecificEntropyUnit.KilocaloriePerGramKelvin);
        ...
        public static SpecificEntropy FromKilojoulesPerKilogramDegreeCelsius(QuantityValue value)
            => new(value, SpecificEntropyUnit.KilojoulePerKilogramDegreeCelsius);
        ...
        public static SpecificEntropy FromKilojoulesPerKilogramKelvin(QuantityValue value)
            => new(value, SpecificEntropyUnit.KilojoulePerKilogramKelvin);
        ...
        public static SpecificEntropy FromMegajoulesPerKilogramDegreeCelsius(QuantityValue value)
            => new(value, SpecificEntropyUnit.MegajoulePerKilogramDegreeCelsius);
        ...
        public static SpecificEntropy FromMegajoulesPerKilogramKelvin(QuantityValue value)
            => new(value, SpecificEntropyUnit.MegajoulePerKilogramKelvin);
        ...
        public static SpecificEntropy Parse(string str, IFormatProvider? provider)
            => QuantityParser.Default.Parse<SpecificEntropy, SpecificEntropyUnit>(str, provider, From);
        ...
        public static bool TryParse([NotNullWhen(true)]string? str, IFormatProvider? provider, out SpecificEntropy result)
            => QuantityParser.Default.TryParse<SpecificEntropy, SpecificEntropyUnit>(str, provider, From, out result);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator QuantityValue(SpecificEntropy d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator SpecificEntropy(QuantityValue d) => new(d, BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator double(SpecificEntropy d) => d.As(BaseUnit);
        ...
        [Obsolete("Gets value of base unit. Use factory methods instead to specify unit conversion.")]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator SpecificEntropy(double d) => new(d, BaseUnit);
        ...
        public static Entropy operator *(SpecificEntropy specificEntropy, Mass mass)
            => Entropy.FromJoulesPerKelvin(specificEntropy.JoulesPerKilogramKelvin * mass.Kilograms);
        ...
        public static SpecificEnergy operator *(SpecificEntropy specificEntropy, TemperatureDelta temperatureDelta)
            => SpecificEnergy.FromJoulesPerKilogram(specificEntropy.JoulesPerKilogramKelvin * temperatureDelta.Kelvins);
        ...
        /// <summary>
        ///     Determines whether two <see cref="SpecificEntropy"/> instances are equal.
        /// </summary>
        /// <remarks>
        ...
        ///     The operator delegates to <see cref="Equals(SpecificEntropy)"/>, which implements this conversion-and-compare logic.
        /// </remarks>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(SpecificEntropy left, SpecificEntropy right)
            => left.Equals(right);
        ...
        /// <summary>
        ///     Determines whether two <see cref="SpecificEntropy"/> instances are not equal.
        /// </summary>
        /// <remarks>
        ///     This operator is the logical negation of <see cref="operator ==(SpecificEntropy,SpecificEntropy)"/>.
        ///     See that operator (and <see cref="Equals(SpecificEntropy)"/>) for details on how equality is evaluated
        ...
        /// <inheritdoc />
        /// <summary>
        ///     Determines whether the specified object is equal to the current <see cref="SpecificEntropy"/> instance.
        /// </summary>
        /// <remarks>
        ///     Returns <c>false</c> if <paramref name="obj"/> is <c>null</c> or not a <see cref="SpecificEntropy"/>.
        ///     When <paramref name="obj"/> is a <see cref="SpecificEntropy"/>, this method delegates to
        ///     <see cref="Equals(SpecificEntropy)"/>, which performs a unit-aware comparison by converting the other
        ///     instance to this instance's unit before comparing numeric values.
        /// </remarks>
        public override bool Equals(object? obj)
            => obj is SpecificEntropy otherQuantity && Equals(otherQuantity);

        /// <inheritdoc />
        /// <summary>
        ///     Determines whether the current instance is equal to another <see cref="SpecificEntropy"/> instance.
        /// </summary>
        /// <remarks>
        ...
        public override int GetHashCode()
            => Comparison.GetHashCode(typeof(SpecificEntropy), this.As(BaseUnit));
